                                ...
                                <>
                                    ...
                                    <div className="w-full space-y-1.5 text-left">
                                        <div className="flex items-center justify-between">
                                            ...
                                            {canResetPassword && (
                                                <Link
                                                    href={request()}
                                                    className="text-xs font-medium text-[#111111]/55 underline-offset-2 transition-colors hover:text-black hover:underline"
                                                >
                                                    Forgot password?
                                                </Link>
                                            )}
                                    ...
                                    <div className="pt-2">
                                        <label className="flex cursor-pointer items-start gap-3">
                                            ...
                                            <span className="text-sm font-medium text-[#111111]/60">
                                                Remember me
                                            </span>
                                        </label>
                                    </div>
                                    ...
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className="mt-6 flex h-11 w-full items-center justify-center rounded-lg bg-[#111111] text-sm font-medium text-white transition-colors hover:bg-black disabled:opacity-50"
                                    >
                                        {processing
                                            ? 'Logging in...'
                                            : 'Log in'}
